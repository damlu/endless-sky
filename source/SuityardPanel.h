...
#ifndef SUITYARD_PANEL_H_
#define SUITYARD_PANEL_H_
...
// Class representing the suityard UI panel, which allows you to buy new suits
// or to sell any of the ones you own. For certain suits, you may need to have a
// certain license to buy them, in which case the cost of the license is added
// to the cost of the suit. (This is intended to be an annoyance, representing
// a government that is particularly repressive of independent pilots.)
class SuityardPanel : public ShopPanel {
public:
	explicit SuityardPanel(PlayerInfo &player);
...
private:
	void BuySuit(const std::string &name);
	void SellSuit();
